...
def detect_boxes_and_items(image_path, output_path="detected_boxes.jpg"):
    ...
    for idx, (x, y, w, h) in enumerate(boxes):
        ...
        item_label = "Unknown"
        if has_item:
            roi_resized = cv2.resize(roi, (224, 224))  # Resize to match input size for ResNet50
            ...
            item_label = decoded_predictions[0][1]  # Get the class label
